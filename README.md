...
Dict is a state-based LWW-Element-Dictionary variants, consists of MapAdd and
MapRemove for add and remove operations.

The underlying map structure is not thread safe. It is expected to implement
additional locking or coordination when using under goroutines.
